...
//special Data
gifImageData=['Image/10.gif','Image/11.gif','Image/12.gif','Image/13.gif','Image/14.gif','Image/15.gif']
...
node.nodeL1.innerHTML='<div><br>Image Formation<br> by Concave Mirror<br><img src="Image/concaveLogo.svg" width="60%"></div>';
            ...
            if(node.nodeL1ClickState%2==0){
                ...
                if(node.nodeL2ClickState[tempIndex1]%2==0){
                    if(node.nodeL3ClickState[tempIndex1][tempIndex2]%2==1){
                        ...
                        if(tempIndex1==1){
                            this.innerHTML+='<image class="gifImage" src='+gifImageData[tempIndex2]+'>';
                        }
...
function updateLine(name,property,value){
